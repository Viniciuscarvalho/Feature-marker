...
- Added bundled PRD, TechSpec, and Tasks templates for creating correct
  `tasks/{slug}/` artifacts.
- Replaced outdated README visual guidance with a skill-first install and

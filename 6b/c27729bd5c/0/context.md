...
Realize o push dessa versão e a atualização para homebrew e para o NPX
...
## Overview
The conversation continues from a previous session where v6.0.0 of feature-marker was being implemented across 15 GitHub issues. The previous session ended with Issue #3 (Prompt Enrichment) partially complete — the SKILL.md file was created bu...
